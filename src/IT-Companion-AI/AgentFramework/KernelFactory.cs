...
public static class KernelFactory
{
    ...
    ///     Thrown when required environment variables are missing or connection is
    ///     unsupported.
    /// </exception>
    ...
    /// <param name="loggerFactory">Logger factory used to propagate structured logging into the kernel.</param>
    /// <returns>Configured shared kernel instance.</returns>
    public static Kernel CreateDefaultKernel(ILoggerFactory loggerFactory)
    {
    ...
    /// <summary>
    ///     Builds the shared <see cref="Kernel" /> with registered model definitions and logging configured in the service
    ///     container.
    /// </summary>
    ...
    /// <exception cref="InvalidOperationException">
    ///     Thrown when the <c>GITHUB_TOKEN</c> environment variable is missing or empty, or when a model registration
    ///     specifies an unsupported connection type.
    /// </exception>
