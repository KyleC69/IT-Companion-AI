...
namespace ITCompanionAI.Entities
{
    public partial class RagRun : INotifyPropertyChanging, INotifyPropertyChanged {
        ...
        private ICollection<RagChunk> _RagChunks;

        private SourceSnapshot _SourceSnapshot;

        public RagRun()
        {
            this._RagChunks = new List<RagChunk>();
            OnCreated();
        }
        ...
        public virtual ICollection<RagChunk> RagChunks
        {
            get
            {
                return this._RagChunks;
            }
            set
            {
                this._RagChunks = value;
            }
        }
