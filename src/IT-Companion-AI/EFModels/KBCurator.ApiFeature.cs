...
// File Name: KBCurator.ApiFeature.cs
// Author: Kyle Crowder
...
public partial class ApiFeature : INotifyPropertyChanging, INotifyPropertyChanged
{
    ...
    partial void OnApiMemberChanging(ApiMember value);

    partial void OnApiMemberChanged();
