...
namespace ITCompanionAI.KBCurator
{
    ...
    public partial class KBContext : DbContext
    {
        ...
        public CheckTemporalConsistencyMultipleResult CheckTemporalConsistency ()
        {

            CheckTemporalConsistencyMultipleResult result = new CheckTemporalConsistencyMultipleResult();
                ...
                using (DbCommand cmd = connection.CreateCommand())
                {
                    ...
                    using (IDataReader reader = cmd.ExecuteReader())
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            CheckTemporalConsistencyResult resultRow = new CheckTemporalConsistencyResult();
                            ...
                            result.CheckTemporalConsistencyResults.Add(resultRow);
                        }
                        reader.NextResult();
                        ...
                        while (reader.Read())
                        {
                            ...
                            CheckTemporalConsistencyResult1 resultRow = new CheckTemporalConsistencyResult1();
                            if (fieldNames.Contains(@"table_name") && !reader.IsDBNull(reader.GetOrdinal(@"table_name")))
                                resultRow.TableName = (string)Convert.ChangeType(reader.GetValue(reader.GetOrdinal(@"table_name")), typeof(string));
                            ...
                            if (fieldNames.Contains(@"semantic_uid") && !reader.IsDBNull(reader.GetOrdinal(@"semantic_uid")))
                                resultRow.SemanticUid = (string)Convert.ChangeType(reader.GetValue(reader.GetOrdinal(@"semantic_uid")), typeof(string));
                            result.CheckTemporalConsistencyResult1s.Add(resultRow);
                        }
                        reader.NextResult();
                        ...
                        while (reader.Read())
                        {
                            ...
                            CheckTemporalConsistencyResult2 resultRow = new CheckTemporalConsistencyResult2();
                            if (fieldNames.Contains(@"table_name") && !reader.IsDBNull(reader.GetOrdinal(@"table_name")))
                                resultRow.TableName = (string)Convert.ChangeType(reader.GetValue(reader.GetOrdinal(@"table_name")), typeof(string));
                            if (fieldNames.Contains(@"semantic_uid") && !reader.IsDBNull(reader.GetOrdinal(@"semantic_uid")))
                                resultRow.SemanticUid = (string)Convert.ChangeType(reader.GetValue(reader.GetOrdinal(@"semantic_uid")), typeof(string));
                            ...
                            result.CheckTemporalConsistencyResult2s.Add(resultRow);
                        }
                        reader.NextResult();
        ...
        public async Task<CheckTemporalConsistencyMultipleResult> CheckTemporalConsistencyAsync ()
        {
        ...
        public List<GetChangesInIngestionRunResult> GetChangesInIngestionRun (Guid? IngestionRunId)
        {

            List<GetChangesInIngestionRunResult> result = new List<GetChangesInIngestionRunResult>();
            DbConnection connection = this.Database.GetDbConnection();
            bool needClose = false;
            if (connection.State != ConnectionState.Open)
            {
            ...
            try
            {
                using (DbCommand cmd = connection.CreateCommand())
                {
                    ...
                    using (IDataReader reader = cmd.ExecuteReader())
                    {
                        ...
                        while (reader.Read())
                        {
                            GetChangesInIngestionRunResult row = new GetChangesInIngestionRunResult();
        ...
        public async Task<List<GetChangesInIngestionRunResult>> GetChangesInIngestionRunAsync (Guid? IngestionRunId)
        {
        ...
        public List<DocPage> GetDocPageHistory (string SemanticUid)
        {
        ...
        public async Task<List<DocPage>> GetDocPageHistoryAsync (string SemanticUid)
        {
        ...
        public List<ApiFeature> GetFeatureHistory (string SemanticUid)
        {
        ...
        public async Task<List<ApiFeature>> GetFeatureHistoryAsync (string SemanticUid)
        {
        ...
        public List<ApiMember> GetMemberHistory (string SemanticUid)
        {
        ...
        public async Task<List<ApiMember>> GetMemberHistoryAsync (string SemanticUid)
        {
        ...
        public List<ApiType> GetTypeHistory (string SemanticUid)
        {
        ...
        public async Task<List<ApiType>> GetTypeHistoryAsync (string SemanticUid)
        {
        ...
        public UpsertApiParameterMultipleResult UpsertApiParameter (Guid? api_member_id, string name, string type_uid, string nullable_annotation, int? position, string modifier, bool? has_default_value, string default_value_literal, Guid? ingestion_run_id)
        {

            UpsertApiParameterMultipleResult result = new UpsertApiParameterMultipleResult();
            DbConnection connection = this.Database.GetDbConnection();
            bool needClose = false;
            if (connection.State != ConnectionState.Open)
            {
                ...
                using (DbCommand cmd = connection.CreateCommand())
                {
                    ...
                    using (IDataReader reader = cmd.ExecuteReader())
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            UpsertApiParameterResult resultRow = new UpsertApiParameterResult();
                            ...
                            if (fieldNames.Contains(@"id") && !reader.IsDBNull(reader.GetOrdinal(@"id")))
                                ...
                                resultRow.Id = null;
                            result.UpsertApiParameterResults.Add(resultRow);
                        }
                        reader.NextResult();
        ...
        public async Task<UpsertApiParameterMultipleResult> UpsertApiParameterAsync (Guid? api_member_id, string name, string type_uid, string nullable_annotation, int? position, string modifier, bool? has_default_value, string default_value_literal, Guid? ingestion_run_id)
        {
        ...
        public VerifyIngestionRunMultipleResult VerifyIngestionRun (Guid? IngestionRunId)
        {

            VerifyIngestionRunMultipleResult result = new VerifyIngestionRunMultipleResult();
            DbConnection connection = this.Database.GetDbConnection();
            bool needClose = false;
            if (connection.State != ConnectionState.Open)
            {
                ...
                using (DbCommand cmd = connection.CreateCommand())
                {
                    ...
                    using (IDataReader reader = cmd.ExecuteReader())
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            VerifyIngestionRunResult resultRow = new VerifyIngestionRunResult();
                            ...
                            result.VerifyIngestionRunResults.Add(resultRow);
                        }
                        reader.NextResult();
        ...
        public async Task<VerifyIngestionRunMultipleResult> VerifyIngestionRunAsync (Guid? IngestionRunId)
        {
        ...
        private void ApiMemberMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ApiMember>().Property(x => x.ApiTypeId).HasColumnName(@"api_type_id").HasColumnType(@"uniqueidentifier").IsRequired().ValueGeneratedNever();
            ...
            modelBuilder.Entity<ApiMember>().Property(x => x.UpdatedIngestionRunId).HasColumnName(@"updated_ingestion_run_id").HasColumnType(@"uniqueidentifier").IsRequired().ValueGeneratedNever();
            ...
            modelBuilder.Entity<ApiMember>().HasIndex(@"ApiTypeId", @"MemberUidHash").IsUnique(true).HasDatabaseName(@"ix_api_member_type_hash");
        ...
        private void SourceSnapshotMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SourceSnapshot>().Property(x => x.SnapshotUid).HasColumnName(@"snapshot_uid").HasColumnType(@"nvarchar(1000)").IsRequired().ValueGeneratedNever().HasMaxLength(1000);
        ...
        {
            modelBuilder.Entity<ApiFeature>().HasOne(x => x.TruthRun).WithMany(op => op.ApiFeatures).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"TruthRunId").IsRequired(true);
            modelBuilder.Entity<ApiFeature>().HasOne(x => x.IngestionRun_CreatedIngestionRunId).WithMany(op => op.ApiFeatures_CreatedIngestionRunId).HasForeignKey(@"CreatedIngestionRunId").IsRequired(true);
            modelBuilder.Entity<ApiFeature>().HasOne(x => x.IngestionRun_UpdatedIngestionRunId).WithMany(op => op.ApiFeatures_UpdatedIngestionRunId).HasForeignKey(@"UpdatedIngestionRunId").IsRequired(true);
            ...
            modelBuilder.Entity<ApiFeature>().HasOne(x => x.SemanticIdentity).WithMany(op => op.ApiFeatures).HasForeignKey(@"SemanticUidHash").IsRequired(false);
            modelBuilder.Entity<ApiFeature>().HasMany(x => x.FeatureDocLinks).WithOne(op => op.ApiFeature).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"FeatureId").IsRequired(true);
            modelBuilder.Entity<ApiFeature>().HasMany(x => x.FeatureMemberLinks).WithOne(op => op.ApiFeature).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"FeatureId").IsRequired(true);
            modelBuilder.Entity<ApiFeature>().HasMany(x => x.FeatureTypeLinks).WithOne(op => op.ApiFeature).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"FeatureId").IsRequired(true);

            modelBuilder.Entity<ApiMember>().HasOne(x => x.IngestionRun_CreatedIngestionRunId).WithMany(op => op.ApiMembers_CreatedIngestionRunId).HasForeignKey(@"CreatedIngestionRunId").IsRequired(true);
            modelBuilder.Entity<ApiMember>().HasOne(x => x.IngestionRun_UpdatedIngestionRunId).WithMany(op => op.ApiMembers_UpdatedIngestionRunId).HasForeignKey(@"UpdatedIngestionRunId").IsRequired(true);
            ...
            modelBuilder.Entity<ApiMemberDiff>().HasOne(x => x.SnapshotDiff).WithMany(op => op.ApiMemberDiffs).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"SnapshotDiffId").IsRequired(true);

            modelBuilder.Entity<ApiType>().HasOne(x => x.SourceSnapshot).WithMany(op => op.ApiTypes).HasForeignKey(@"SourceSnapshotId").IsRequired(true);
            modelBuilder.Entity<ApiType>().HasOne(x => x.IngestionRun_CreatedIngestionRunId).WithMany(op => op.ApiTypes_CreatedIngestionRunId).HasForeignKey(@"CreatedIngestionRunId").IsRequired(true);
            modelBuilder.Entity<ApiType>().HasOne(x => x.IngestionRun_UpdatedIngestionRunId).WithMany(op => op.ApiTypes_UpdatedIngestionRunId).HasForeignKey(@"UpdatedIngestionRunId").IsRequired(true);
            ...
            modelBuilder.Entity<ApiTypeDiff>().HasOne(x => x.SnapshotDiff).WithMany(op => op.ApiTypeDiffs).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"SnapshotDiffId").IsRequired(true);

            modelBuilder.Entity<CodeBlock>().HasOne(x => x.DocSection).WithMany(op => op.CodeBlocks).HasForeignKey(@"DocSectionId").IsRequired(true);
            modelBuilder.Entity<CodeBlock>().HasOne(x => x.IngestionRun_CreatedIngestionRunId).WithMany(op => op.CodeBlocks_CreatedIngestionRunId).HasForeignKey(@"CreatedIngestionRunId").IsRequired(true);
            modelBuilder.Entity<CodeBlock>().HasOne(x => x.IngestionRun_UpdatedIngestionRunId).WithMany(op => op.CodeBlocks_UpdatedIngestionRunId).HasForeignKey(@"UpdatedIngestionRunId").IsRequired(true);
            ...
            modelBuilder.Entity<DocPage>().HasOne(x => x.SourceSnapshot).WithMany(op => op.DocPages).HasForeignKey(@"SourceSnapshotId").IsRequired(true);
            modelBuilder.Entity<DocPage>().HasOne(x => x.IngestionRun_CreatedIngestionRunId).WithMany(op => op.DocPages_CreatedIngestionRunId).HasForeignKey(@"CreatedIngestionRunId").IsRequired(true);
            modelBuilder.Entity<DocPage>().HasOne(x => x.IngestionRun_UpdatedIngestionRunId).WithMany(op => op.DocPages_UpdatedIngestionRunId).HasForeignKey(@"UpdatedIngestionRunId").IsRequired(true);
            ...
            modelBuilder.Entity<DocPage>().HasOne(x => x.SemanticIdentity).WithMany(op => op.DocPages).HasForeignKey(@"SemanticUidHash").IsRequired(false);
            modelBuilder.Entity<DocPage>().HasMany(x => x.DocSections).WithOne(op => op.DocPage).HasForeignKey(@"DocPageId").IsRequired(true);

            modelBuilder.Entity<DocPageDiff>().HasOne(x => x.SnapshotDiff).WithMany(op => op.DocPageDiffs).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"SnapshotDiffId").IsRequired(true);

            modelBuilder.Entity<DocSection>().HasMany(x => x.CodeBlocks).WithOne(op => op.DocSection).HasForeignKey(@"DocSectionId").IsRequired(true);
            modelBuilder.Entity<DocSection>().HasOne(x => x.DocPage).WithMany(op => op.DocSections).HasForeignKey(@"DocPageId").IsRequired(true);
            modelBuilder.Entity<DocSection>().HasOne(x => x.IngestionRun_CreatedIngestionRunId).WithMany(op => op.DocSections_CreatedIngestionRunId).HasForeignKey(@"CreatedIngestionRunId").IsRequired(true);
            modelBuilder.Entity<DocSection>().HasOne(x => x.IngestionRun_UpdatedIngestionRunId).WithMany(op => op.DocSections_UpdatedIngestionRunId).HasForeignKey(@"UpdatedIngestionRunId").IsRequired(true);
            ...
            modelBuilder.Entity<DocSection>().HasOne(x => x.SemanticIdentity).WithMany(op => op.DocSections).HasForeignKey(@"SemanticUidHash").IsRequired(false);

            modelBuilder.Entity<ExecutionResult>().HasOne(x => x.ExecutionRun).WithMany(op => op.ExecutionResults).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"ExecutionRunId").IsRequired(true);

            modelBuilder.Entity<ExecutionRun>().HasMany(x => x.ExecutionResults).WithOne(op => op.ExecutionRun).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"ExecutionRunId").IsRequired(true);
            modelBuilder.Entity<ExecutionRun>().HasOne(x => x.SourceSnapshot).WithMany(op => op.ExecutionRuns).HasForeignKey(@"SnapshotId").IsRequired(true);
            modelBuilder.Entity<ExecutionRun>().HasOne(x => x.SampleRun).WithMany(op => op.ExecutionRuns).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"SampleRunId").IsRequired(true);

            modelBuilder.Entity<FeatureDocLink>().HasOne(x => x.ApiFeature).WithMany(op => op.FeatureDocLinks).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"FeatureId").IsRequired(true);

            modelBuilder.Entity<FeatureMemberLink>().HasOne(x => x.ApiFeature).WithMany(op => op.FeatureMemberLinks).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"FeatureId").IsRequired(true);

            modelBuilder.Entity<FeatureTypeLink>().HasOne(x => x.ApiFeature).WithMany(op => op.FeatureTypeLinks).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"FeatureId").IsRequired(true);

            modelBuilder.Entity<IngestionRun>().HasMany(x => x.ApiFeatures_CreatedIngestionRunId).WithOne(op => op.IngestionRun_CreatedIngestionRunId).HasForeignKey(@"CreatedIngestionRunId").IsRequired(true);
            modelBuilder.Entity<IngestionRun>().HasMany(x => x.ApiFeatures_UpdatedIngestionRunId).WithOne(op => op.IngestionRun_UpdatedIngestionRunId).HasForeignKey(@"UpdatedIngestionRunId").IsRequired(true);
            ...
            modelBuilder.Entity<IngestionRun>().HasMany(x => x.ApiMembers_CreatedIngestionRunId).WithOne(op => op.IngestionRun_CreatedIngestionRunId).HasForeignKey(@"CreatedIngestionRunId").IsRequired(true);
            modelBuilder.Entity<IngestionRun>().HasMany(x => x.ApiMembers_UpdatedIngestionRunId).WithOne(op => op.IngestionRun_UpdatedIngestionRunId).HasForeignKey(@"UpdatedIngestionRunId").IsRequired(true);
            ...
            modelBuilder.Entity<IngestionRun>().HasMany(x => x.ApiTypes_CreatedIngestionRunId).WithOne(op => op.IngestionRun_CreatedIngestionRunId).HasForeignKey(@"CreatedIngestionRunId").IsRequired(true);
            modelBuilder.Entity<IngestionRun>().HasMany(x => x.ApiTypes_UpdatedIngestionRunId).WithOne(op => op.IngestionRun_UpdatedIngestionRunId).HasForeignKey(@"UpdatedIngestionRunId").IsRequired(true);
            ...
            modelBuilder.Entity<IngestionRun>().HasMany(x => x.CodeBlocks_CreatedIngestionRunId).WithOne(op => op.IngestionRun_CreatedIngestionRunId).HasForeignKey(@"CreatedIngestionRunId").IsRequired(true);
            modelBuilder.Entity<IngestionRun>().HasMany(x => x.CodeBlocks_UpdatedIngestionRunId).WithOne(op => op.IngestionRun_UpdatedIngestionRunId).HasForeignKey(@"UpdatedIngestionRunId").IsRequired(true);
            ...
            modelBuilder.Entity<IngestionRun>().HasMany(x => x.DocPages_CreatedIngestionRunId).WithOne(op => op.IngestionRun_CreatedIngestionRunId).HasForeignKey(@"CreatedIngestionRunId").IsRequired(true);
            modelBuilder.Entity<IngestionRun>().HasMany(x => x.DocPages_UpdatedIngestionRunId).WithOne(op => op.IngestionRun_UpdatedIngestionRunId).HasForeignKey(@"UpdatedIngestionRunId").IsRequired(true);
            ...
            modelBuilder.Entity<IngestionRun>().HasMany(x => x.DocSections_CreatedIngestionRunId).WithOne(op => op.IngestionRun_CreatedIngestionRunId).HasForeignKey(@"CreatedIngestionRunId").IsRequired(true);
            modelBuilder.Entity<IngestionRun>().HasMany(x => x.DocSections_UpdatedIngestionRunId).WithOne(op => op.IngestionRun_UpdatedIngestionRunId).HasForeignKey(@"UpdatedIngestionRunId").IsRequired(true);
            ...
            modelBuilder.Entity<IngestionRun>().HasMany(x => x.SourceSnapshots).WithOne(op => op.IngestionRun).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"IngestionRunId").IsRequired(true);

            modelBuilder.Entity<RagChunk>().HasOne(x => x.RagRun).WithMany(op => op.RagChunks).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"RagRunId").IsRequired(true);

            modelBuilder.Entity<RagRun>().HasMany(x => x.RagChunks).WithOne(op => op.RagRun).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"RagRunId").IsRequired(true);
            modelBuilder.Entity<RagRun>().HasOne(x => x.SourceSnapshot).WithMany(op => op.RagRuns).HasForeignKey(@"SnapshotId").IsRequired(true);

            modelBuilder.Entity<ReviewIssue>().HasOne(x => x.ReviewItem).WithMany(op => op.ReviewIssues).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"ReviewItemId").IsRequired(true);

            modelBuilder.Entity<ReviewItem>().HasMany(x => x.ReviewIssues).WithOne(op => op.ReviewItem).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"ReviewItemId").IsRequired(true);
            modelBuilder.Entity<ReviewItem>().HasOne(x => x.ReviewRun).WithMany(op => op.ReviewItems).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"ReviewRunId").IsRequired(true);

            modelBuilder.Entity<ReviewRun>().HasMany(x => x.ReviewItems).WithOne(op => op.ReviewRun).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"ReviewRunId").IsRequired(true);
            modelBuilder.Entity<ReviewRun>().HasOne(x => x.SourceSnapshot).WithMany(op => op.ReviewRuns).HasForeignKey(@"SnapshotId").IsRequired(true);

            modelBuilder.Entity<Sample>().HasOne(x => x.SampleRun).WithMany(op => op.Samples).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"SampleRunId").IsRequired(true);
            modelBuilder.Entity<Sample>().HasMany(x => x.SampleApiMemberLinks).WithOne(op => op.Sample).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"SampleId").IsRequired(true);

            modelBuilder.Entity<SampleApiMemberLink>().HasOne(x => x.Sample).WithMany(op => op.SampleApiMemberLinks).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"SampleId").IsRequired(true);

            modelBuilder.Entity<SampleRun>().HasMany(x => x.ExecutionRuns).WithOne(op => op.SampleRun).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"SampleRunId").IsRequired(true);
            modelBuilder.Entity<SampleRun>().HasMany(x => x.Samples).WithOne(op => op.SampleRun).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"SampleRunId").IsRequired(true);
            modelBuilder.Entity<SampleRun>().HasOne(x => x.SourceSnapshot).WithMany(op => op.SampleRuns).HasForeignKey(@"SnapshotId").IsRequired(true);

            modelBuilder.Entity<SemanticIdentity>().HasMany(x => x.ApiFeatures).WithOne(op => op.SemanticIdentity).HasForeignKey(@"SemanticUidHash").IsRequired(false);
            modelBuilder.Entity<SemanticIdentity>().HasMany(x => x.DocPages).WithOne(op => op.SemanticIdentity).HasForeignKey(@"SemanticUidHash").IsRequired(false);
            modelBuilder.Entity<SemanticIdentity>().HasMany(x => x.DocSections).WithOne(op => op.SemanticIdentity).HasForeignKey(@"SemanticUidHash").IsRequired(false);

            modelBuilder.Entity<SnapshotDiff>().HasMany(x => x.ApiMemberDiffs).WithOne(op => op.SnapshotDiff).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"SnapshotDiffId").IsRequired(true);
            modelBuilder.Entity<SnapshotDiff>().HasMany(x => x.ApiTypeDiffs).WithOne(op => op.SnapshotDiff).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"SnapshotDiffId").IsRequired(true);
            modelBuilder.Entity<SnapshotDiff>().HasMany(x => x.DocPageDiffs).WithOne(op => op.SnapshotDiff).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"SnapshotDiffId").IsRequired(true);
            modelBuilder.Entity<SnapshotDiff>().HasOne(x => x.SourceSnapshot_OldSnapshotId).WithMany(op => op.SnapshotDiffs_OldSnapshotId).HasForeignKey(@"OldSnapshotId").IsRequired(true);
            modelBuilder.Entity<SnapshotDiff>().HasOne(x => x.SourceSnapshot_NewSnapshotId).WithMany(op => op.SnapshotDiffs_NewSnapshotId).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"NewSnapshotId").IsRequired(true);

            modelBuilder.Entity<SourceSnapshot>().HasMany(x => x.ApiTypes).WithOne(op => op.SourceSnapshot).HasForeignKey(@"SourceSnapshotId").IsRequired(true);
            modelBuilder.Entity<SourceSnapshot>().HasMany(x => x.DocPages).WithOne(op => op.SourceSnapshot).HasForeignKey(@"SourceSnapshotId").IsRequired(true);
            modelBuilder.Entity<SourceSnapshot>().HasMany(x => x.ExecutionRuns).WithOne(op => op.SourceSnapshot).HasForeignKey(@"SnapshotId").IsRequired(true);
            modelBuilder.Entity<SourceSnapshot>().HasMany(x => x.RagRuns).WithOne(op => op.SourceSnapshot).HasForeignKey(@"SnapshotId").IsRequired(true);
            modelBuilder.Entity<SourceSnapshot>().HasMany(x => x.ReviewRuns).WithOne(op => op.SourceSnapshot).HasForeignKey(@"SnapshotId").IsRequired(true);
            modelBuilder.Entity<SourceSnapshot>().HasMany(x => x.SampleRuns).WithOne(op => op.SourceSnapshot).HasForeignKey(@"SnapshotId").IsRequired(true);
            modelBuilder.Entity<SourceSnapshot>().HasMany(x => x.SnapshotDiffs_OldSnapshotId).WithOne(op => op.SourceSnapshot_OldSnapshotId).HasForeignKey(@"OldSnapshotId").IsRequired(true);
            modelBuilder.Entity<SourceSnapshot>().HasMany(x => x.SnapshotDiffs_NewSnapshotId).WithOne(op => op.SourceSnapshot_NewSnapshotId).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"NewSnapshotId").IsRequired(true);
            modelBuilder.Entity<SourceSnapshot>().HasOne(x => x.IngestionRun).WithMany(op => op.SourceSnapshots).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"IngestionRunId").IsRequired(true);
            modelBuilder.Entity<SourceSnapshot>().HasMany(x => x.TruthRuns).WithOne(op => op.SourceSnapshot).HasForeignKey(@"SnapshotId").IsRequired(true);

            modelBuilder.Entity<TruthRun>().HasMany(x => x.ApiFeatures).WithOne(op => op.TruthRun).OnDelete(DeleteBehavior.Cascade).HasForeignKey(@"TruthRunId").IsRequired(true);
            modelBuilder.Entity<TruthRun>().HasOne(x => x.SourceSnapshot).WithMany(op => op.TruthRuns).HasForeignKey(@"SnapshotId").IsRequired(true);
        }
    ...
    public class CheckTemporalConsistencyMultipleResult
    {

        public CheckTemporalConsistencyMultipleResult()
        {
          CheckTemporalConsistencyResults = new List<CheckTemporalConsistencyResult>();
          CheckTemporalConsistencyResults1 = new List<CheckTemporalConsistencyResult>();
          CheckTemporalConsistencyResults2 = new List<CheckTemporalConsistencyResult>();
          CheckTemporalConsistencyResults3 = new List<CheckTemporalConsistencyResult>();
          CheckTemporalConsistencyResult1s = new List<CheckTemporalConsistencyResult1>();
          CheckTemporalConsistencyResult1s1 = new List<CheckTemporalConsistencyResult1>();
          CheckTemporalConsistencyResult1s2 = new List<CheckTemporalConsistencyResult1>();
          CheckTemporalConsistencyResult1s3 = new List<CheckTemporalConsistencyResult1>();
          CheckTemporalConsistencyResult2s = new List<CheckTemporalConsistencyResult2>();
          CheckTemporalConsistencyResult2s1 = new List<CheckTemporalConsistencyResult2>();
          CheckTemporalConsistencyResult2s2 = new List<CheckTemporalConsistencyResult2>();
          CheckTemporalConsistencyResult2s3 = new List<CheckTemporalConsistencyResult2>();
        }

        public List<CheckTemporalConsistencyResult> CheckTemporalConsistencyResults { get; private set; }
        public List<CheckTemporalConsistencyResult> CheckTemporalConsistencyResults1 { get; private set; }
        public List<CheckTemporalConsistencyResult> CheckTemporalConsistencyResults2 { get; private set; }
        public List<CheckTemporalConsistencyResult> CheckTemporalConsistencyResults3 { get; private set; }
        public List<CheckTemporalConsistencyResult1> CheckTemporalConsistencyResult1s { get; private set; }
        public List<CheckTemporalConsistencyResult1> CheckTemporalConsistencyResult1s1 { get; private set; }
        public List<CheckTemporalConsistencyResult1> CheckTemporalConsistencyResult1s2 { get; private set; }
        public List<CheckTemporalConsistencyResult1> CheckTemporalConsistencyResult1s3 { get; private set; }
        public List<CheckTemporalConsistencyResult2> CheckTemporalConsistencyResult2s { get; private set; }
        public List<CheckTemporalConsistencyResult2> CheckTemporalConsistencyResult2s1 { get; private set; }
        public List<CheckTemporalConsistencyResult2> CheckTemporalConsistencyResult2s2 { get; private set; }
        public List<CheckTemporalConsistencyResult2> CheckTemporalConsistencyResult2s3 { get; private set; }
    }

    public class UpsertApiParameterMultipleResult
    {

        public UpsertApiParameterMultipleResult()
        {
          UpsertApiParameterResults = new List<UpsertApiParameterResult>();
          UpsertApiParameterResults1 = new List<UpsertApiParameterResult>();
          UpsertApiParameterResults2 = new List<UpsertApiParameterResult>();
        }

        public List<UpsertApiParameterResult> UpsertApiParameterResults { get; private set; }
        public List<UpsertApiParameterResult> UpsertApiParameterResults1 { get; private set; }
        public List<UpsertApiParameterResult> UpsertApiParameterResults2 { get; private set; }
    }

    public class VerifyIngestionRunMultipleResult
    {

        public VerifyIngestionRunMultipleResult()
        {
          VerifyIngestionRunResults = new List<VerifyIngestionRunResult>();
          VerifyIngestionRunResults1 = new List<VerifyIngestionRunResult>();
        }

        public List<VerifyIngestionRunResult> VerifyIngestionRunResults { get; private set; }
        public List<VerifyIngestionRunResult> VerifyIngestionRunResults1 { get; private set; }
    }
}
