...
// File Name: KBCurator.KBContext.cs
// Author: Kyle Crowder
...
public partial class KBContext : DbContext
{
    ...
    public SpCheckTemporalConsistencyMultipleResult SpCheckTemporalConsistency()
    {
        ...
        var result = new SpCheckTemporalConsistencyMultipleResult();
        DbConnection connection = this.Database.GetDbConnection();
        var needClose = false;
        if (connection.State != ConnectionState.Open)
        {
            ...
            using (DbCommand cmd = connection.CreateCommand())
            {
                ...
                using (IDataReader reader = cmd.ExecuteReader())
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        var resultRow = new SpCheckTemporalConsistencyResult();
                    ...
                    while (reader.Read())
                    {
                        ...
                        var resultRow = new SpCheckTemporalConsistencyResult1();
                        if (fieldNames.Contains(@"table_name") && !reader.IsDBNull(reader.GetOrdinal(@"table_name")))
                        {
                            resultRow.TableName = (string)Convert.ChangeType(reader.GetValue(reader.GetOrdinal(@"table_name")), typeof(string));
                        }
                    ...
                    while (reader.Read())
                    {
                        ...
                        var resultRow = new SpCheckTemporalConsistencyResult2();
                        if (fieldNames.Contains(@"table_name") && !reader.IsDBNull(reader.GetOrdinal(@"table_name")))
                        {
                            resultRow.TableName = (string)Convert.ChangeType(reader.GetValue(reader.GetOrdinal(@"table_name")), typeof(string));
                        }
    ...
    public List<SpGetChangesInIngestionRunResult> SpGetChangesInIngestionRun(Guid? IngestionRunId)
    {
        ...
        List<SpGetChangesInIngestionRunResult> result = new();
        DbConnection connection = this.Database.GetDbConnection();
        var needClose = false;
        if (connection.State != ConnectionState.Open)
        {
        ...
        try
        {
            using (DbCommand cmd = connection.CreateCommand())
            {
                ...
                using (IDataReader reader = cmd.ExecuteReader())
                {
                    ...
                    while (reader.Read())
                    {
                        var row = new SpGetChangesInIngestionRunResult();
    ...
    public SpUpsertApiParameterMultipleResult SpUpsertApiParameter(Guid? api_member_id, string name, string type_uid, string nullable_annotation, int? position, string modifier, bool? has_default_value, string default_value_literal, Guid? ingestion_run_id)
    {
        ...
        var result = new SpUpsertApiParameterMultipleResult();
        DbConnection connection = this.Database.GetDbConnection();
        var needClose = false;
        if (connection.State != ConnectionState.Open)
        {
            ...
            using (DbCommand cmd = connection.CreateCommand())
            {
                ...
                using (IDataReader reader = cmd.ExecuteReader())
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        var resultRow = new SpUpsertApiParameterResult();
    ...
    public SpVerifyIngestionRunMultipleResult SpVerifyIngestionRun(Guid? IngestionRunId)
    {
        ...
        var result = new SpVerifyIngestionRunMultipleResult();
        DbConnection connection = this.Database.GetDbConnection();
        var needClose = false;
        if (connection.State != ConnectionState.Open)
        {
            ...
            using (DbCommand cmd = connection.CreateCommand())
            {
                ...
                using (IDataReader reader = cmd.ExecuteReader())
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        var resultRow = new SpVerifyIngestionRunResult();
    ...
    public List<VApiFeatureCurrent> FnGetFeatureAsOf(string SemanticUid, DateTime? AsOfUtc)
    {

        List<VApiFeatureCurrent> result = new();
        DbConnection connection = this.Database.GetDbConnection();
        var needClose = false;
        if (connection.State != ConnectionState.Open)
        {
        ...
        try
        {
            using (DbCommand cmd = connection.CreateCommand())
            {
                ...
                using (IDataReader reader = cmd.ExecuteReader())
                {
                    ...
                    while (reader.Read())
                    {
                        var row = new VApiFeatureCurrent();
                        if (fieldNames.Contains("id") && !reader.IsDBNull(reader.GetOrdinal(@"id")))
                        {
                            row.Id = (Guid)Convert.ChangeType(reader.GetValue(reader.GetOrdinal(@"id")), typeof(Guid));
                        }
    ...
    public async Task<List<VApiFeatureCurrent>> FnGetFeatureAsOfAsync(string SemanticUid, DateTime? AsOfUtc)
    {
    ...
    public List<VApiMemberCurrent> FnGetMemberAsOf(string SemanticUid, DateTime? AsOfUtc)
    {

        List<VApiMemberCurrent> result = new();
        DbConnection connection = this.Database.GetDbConnection();
        var needClose = false;
        if (connection.State != ConnectionState.Open)
        {
    ...
    public async Task<List<VApiMemberCurrent>> FnGetMemberAsOfAsync(string SemanticUid, DateTime? AsOfUtc)
    {
    ...
    private void VApiMemberCurrentMapping(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<VApiMemberCurrent>().Property(x => x.ApiTypeId).HasColumnName(@"api_type_id").HasColumnType(@"uniqueidentifier").IsRequired().ValueGeneratedNever();
        ...
        modelBuilder.Entity<VApiMemberCurrent>().Property(x => x.UpdatedIngestionRunId).HasColumnName(@"updated_ingestion_run_id").HasColumnType(@"uniqueidentifier").IsRequired().ValueGeneratedNever();
