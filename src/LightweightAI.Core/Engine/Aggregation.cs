...
using LightweightAI.Core.LightweightAI.Aggregation;
using LightweightAI.Core.LightweightAI.Modeling;
using LightweightAI.Core.Models;

using UnifiedAggregator = LightweightAI.Core.LightweightAI.Aggregation.UnifiedAggregator;
...
namespace LightweightAI.Core.LightweightAI.Refinery
{
...
namespace LightweightAI.Core.LightweightAI.Aggregation
{
...
namespace LightweightAI.Core.LightweightAI.Modeling
{
    public sealed class SnapshotTrendModel : ISnapshotTrendModel
    {
        ...
        {
            this._cfg = cfg;
            this._window = new Queue<TrendPoint>(Math.Max(4, cfg.Window));
            this._sum = 0d;
            this._sumSquares = 0d;
            this._ema = 0d;
            this._hasLast = false;
            this._last = new TrendPoint(DateTimeOffset.MinValue, 0);
            this.Current = new Snapshot(DateTimeOffset.MinValue, 0, 0, 0, 0, 0, 0);
        }
...
namespace LightweightAI.Core.LightweightAI.Unified
{
